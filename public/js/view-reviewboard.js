...
window.ReviewBoardRenderer = {
  ...
  REVIEW_QUOTES: [
    ...
    ['COMMUNICATION: MOSTLY GRUNTS',
     'AND EMPHATIC CLAPPING',
     'PROFESSIONALISM: ON A SLIDING SCALE',
     'DRESS CODE: ONLY TECHNICALLY COMPLIANT',
     'GENERAL ATTITUDE: WEAPONIZED APATHY'],
    ...
    ['CONSISTENTLY DOES THE ABSOLUTE LEAST POSSIBLE',
    ...
    ['PEAK INDIVIDUAL PERFORMANCE WAS RECORDED',
     'ON ONE SPECIFIC TUESDAY MARCH 11TH 2024',
    ...
    ['EMPLOYEE HAS SAVED 47 GIGABYTES OF FILES',
     'TO THE SHARED DRIVE LABELED DO NOT DELETE',
     'NONE OF THEM APPEAR TO BE WORK RELATED',
     'IT HAS BEEN REQUESTED THEY CLEAN IT UP',
     'THE FOLDER HAS SINCE GROWN TO 53 GIGABYTES'],
    ...
    ['ARRIVES EACH MORNING AND SPENDS THE FIRST',
     ...
     'THEY ARE IN FACT SCROLLING REDDIT',
     'AND WATCHING YOUTUBE'],
    ['HAS SET A PERSONAL GOAL OF SECURING',
     'A RAISE WITHOUT ANY ADDITIONAL EFFORT',
     'HAS CLEAR MANAGEMENT POTENTIAL'],
    ...
    ['PROCESSING EMPLOYEE PERFORMANCE DATA',
     ...
     'NOTE: THE MODEL IN QUESTION IS THE EMPLOYEE'],
    ['PREDICTED PERFORMANCE: LOW',
     'ACTUAL PERFORMANCE: LOWER',
     'ADJUSTING FUTURE PREDICTIONS ACCORDINGLY',
     'MODEL NOW PREDICTS NEGATIVE OUTPUT'],
    ['CROSS REFERENCING BADGE SCANS WITH OUTPUT',
     'EMPLOYEE IS PRESENT 40 HOURS PER WEEK',
     'PRODUCTIVITY DETECTED 0 HOURS PER WEEK',
     'CORRELATION: NONE'],
    ['COMPARING EMPLOYEE TO INDUSTRY AVERAGE',
     'ERROR: VALUE TOO LOW TO PLOT',
     'SWITCHING TO LOGARITHMIC SCALE',
     'ERROR: STILL TOO LOW TO PLOT'],
    ['SCORE: MEETS EXPECTATIONS',
     'NOTE: EXPECTATIONS WERE SET CATASTROPHICALLY LOW',
     'AFTER THE INCIDENT WE DO NOT DISCUSS',
     'EMPLOYEE STILL ONLY BARELY SQUEAKED BY'],
    ...
    ['HAS SPENT YEARS SENDING EMAILS WHERE',
     'THE ENTIRE MESSAGE IS IN THE SUBJECT LINE',
     'RECIPIENTS KEEP OPENING THEM ANYWAY',
     'ONLY TO FIND THE BODY COMPLETELY EMPTY'],
    ...
    ['WAS ONCE DESCRIBED AS ESSENTIAL BY A PEER',
     ...
     'COWORKERS AND THEN FORMALLY WRITTEN UP',
    ...
    ['USED FAKE BACKGROUND DURING REVIEW',
     'WAS ACTUALLY AT A SPORTING EVENT',
     'NOT EVEN MAD HONESTLY'],
    ...
    ['ATTEMPTED TO SELL PERSONAL MERCHANDISE',
     'AT THE COMPANY HOLIDAY PARTY LAST DECEMBER',
     'STICKERS BUTTONS AND A DEMO EP',
     'MADE FORTY SEVEN DOLLARS BEFORE SECURITY',
     'ASKED THEM TO STOP AND THEY DID NOT'],
    ['WILL NOT ATTEND ANY MEETING WITHOUT',
     'FIFTEEN MINUTES OF ALONE TIME BEFOREHAND',
     'REFERS TO THE SUPPLY CLOSET AS BACKSTAGE',
     'HAS TAPED A STAR TO THE DOOR WITH NAME',
     'FACILITIES HAS ASKED THEM TO STOP TWICE'],
    ['LEAVES EVERY MEETING FIVE MINUTES EARLY',
     'THEN RETURNS TWO MINUTES LATER UNPROMPTED',
     'CALLS THIS THE ENCORE AND EXPECTS APPLAUSE',
     'HAS NEVER ONCE RECEIVED ANY',
     'CONTINUES TO DO THIS EVERY SINGLE DAY'],
    ['HAS REPEATEDLY ASKED ABOUT THE COMPANY',
     'SHUTTLE AND WHETHER IT CAN BE CONVERTED',
     'INTO A TOUR BUS FOR QUOTE TEAM BUILDING',
     'THE COMPANY DOES NOT HAVE A SHUTTLE',
     'OR A BUS OR A TEAM BUILDING BUDGET'],
    ...
    ['UNDER REVIEW SINCE 2019'],
    ['THIS SPACE INTENTIONALLY LEFT BLANK'],
    ['NO FURTHER ACTION RECOMMENDED OR POSSIBLE'],
    ['ERROR 403 FORBIDDEN'],
    ['NOT THE WORST',
     'NOT THE BEST EITHER',
     'JUST SORT OF HERE'],
    ...
    ["EMPLOYEE'; DROP TABLE REVIEWS;--"],
    ['TECHNICALLY STILL EMPLOYED'],
  ],
